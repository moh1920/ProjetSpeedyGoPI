...
@PostMapping("/pickup/{deliveryId}/{status}")
    public Delivery pickupDelivery(@PathVariable Long deliveryId,@PathVariable String status) {
        return deliveryService.pickupDelivery(deliveryId, status);
